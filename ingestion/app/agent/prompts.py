...
5) Assume all times are in the IST timezone (UTC+05:30) unless stated otherwise. Convert all output start_iso and end_iso time slots to UTC string format (ending in Z).
